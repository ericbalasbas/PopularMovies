...
public class MovieTrailerListAdapter extends ArrayAdapter<MovieTrailer> {
     ...
     * @param movieTrailers A List of Movie objects to display in a list
     */
    MovieTrailerListAdapter(Activity context, List<MovieTrailer> movieTrailers) {
